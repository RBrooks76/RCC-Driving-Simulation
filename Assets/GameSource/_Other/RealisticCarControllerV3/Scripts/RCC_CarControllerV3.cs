...
public class RCC_CarControllerV3 : MonoBehaviour
{
	...
	private static RCC_CarControllerV3 r_instance;
    ...
    public void CreateWheelColliders()
    {
        ...
        allWheelModels.Add(FrontLeftWheelTransform);
        allWheelModels.Add(FrontRightWheelTransform);
        allWheelModels.Add(RearLeftWheelTransform);
        allWheelModels.Add(RearRightWheelTransform);
