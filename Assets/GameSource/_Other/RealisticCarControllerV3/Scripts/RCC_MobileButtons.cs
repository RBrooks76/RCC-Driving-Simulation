...
public class RCC_MobileButtons : MonoBehaviour {
	...
	public RCC_UIController leftIndicatorButton;
	public RCC_UIController rightIndicatorButton;
	...
	private float leftIndicatorInput = 0f;
	private float rightIndicatorInput = 0f;
	...
	void Start(){
		...
		if(RCCSettings.controllerType != RCC_Settings.ControllerType.Mobile){
			...
			if(leftIndicatorButton)
				leftIndicatorButton.gameObject.SetActive(false);
			if(rightIndicatorButton)
				rightIndicatorButton.gameObject.SetActive(false);
	...
	void Update(){
		...
		leftIndicatorInput = GetInput(leftIndicatorButton);
		rightIndicatorInput = GetInput(rightIndicatorButton);
